...
df=pd.read_csv("E:\IOnewspaper\IOnewspaper\Circulation\TheWholeCirculationNewspaperOwnerNameStandardized2023VManual.csv")
...
df=df[df['Owner']!='lithuanian can. r. c. cultural soc. inc.']
...
#with open('E:\IOnewspaper\openaipdf\LocationGPS.pkl', 'wb') as file:
#    pickle.dump(LocationGPS, file)

# Read the dictionary from the file
with open('E:\IOnewspaper\openaipdf\LocationGPS.pkl', 'rb') as file:
...
CSDdf=pd.read_csv(r'E:\IOnewspaper\openaipdf\CSD2016\CSDdfManual.csv')
CSDdf.reset_index(drop=True,inplace=True)
...
dfChass2.to_csv(r'E:\IOnewspaper\openaipdf\CSD2016\dfChass2.csv')
...
CSDdf3.to_csv(r'E:\IOnewspaper\openaipdf\CSD2016\CSDdf3.csv')

CSDdf3=pd.read_csv(r'E:\IOnewspaper\openaipdf\CSD2016\CSDdf3.csv',index_col=0)
...
CSDdf4.to_csv(r"E:\IOnewspaper\openaipdf\CSD2016\CSDdf4-2.csv")
